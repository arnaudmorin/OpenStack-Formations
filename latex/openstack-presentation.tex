  ...
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item OVH\pause
      \item Mais aussi : Mirantis, StackOps, eNovance (racheté par Red Hat), DreamHost, Hastexo\pause
  ...
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item En France : \textbf{Cloudwatt} et \textbf{OVH}\pause
      \item Wikimedia
      \item CERN
      \item Paypal
      \item Comcast
...
\end{verbatim}
  ...
  \begin{frame}
    ...
    \begin{itemize}
      ...
      \item L'utilisation de Vagrant est conseillée (docker possible avec dockenstack)
    \end{itemize}
  \end{frame}
